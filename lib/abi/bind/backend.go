...
type ContractTransactor interface {
	...
	EstimateGas(ctx context.Context, call kardia.CallMsg) (gas uint64, err error)
...
type ContractFilterer interface {
	...
	SubscribeFilterLogs(ctx context.Context, query kardia.FilterQuery, ch chan<- types.Log) (event.Subscription, error)
}
